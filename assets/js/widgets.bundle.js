...
var KTChartsWidget17 = (function () {
    ...
    var initChart = function () {
        ...
        var init = function () {
            ...
            // series.data.setAll([
            //     {
            //         value: 40, category: "Super", sliceSettings: {
            //             fill: am5.color(0xd6e681),
            //             stroke: am5.color(0xd6e681)
            //         }
            //     },
            //     { value: 30, category: "Lubricants", fill: am5.color(KTUtil.getCssVariableValue('--bs-success')) },
            //     { value: 20, category: "Diesel", fill: am5.color(KTUtil.getCssVariableValue('--bs-danger')) },
            //     { value: 10, category: "Services", fill: am5.color(KTUtil.getCssVariableValue('--bs-warning')) }
            // ]);
            ...
            // Set data
            series.data.setAll([
                { value: 40, category: "Super" },
                { value: 30, category: "Lubricants" },
                { value: 20, category: "Diesel" },
                { value: 10, category: "Services" }
            ]);
...
window.KTChartsWidget17 = KTChartsWidget17
...
var KTChartsWidget35 = function () {
    ...
    var initChart = function (chart, toggle, chartSelector, data, labels, initByDefault) {
        ...
        var labelColor = KTUtil.getCssVariableValue('--bs-gray-200');
        var borderColor = KTUtil.getCssVariableValue('--bs-border-dashed-color');
        var baseColor = KTUtil.getCssVariableValue('--bs-' + color);
    ...
    return {
        init: function () {
            var chart1Data = [2600, 3200, 2300, 2300, 2000, 3200, 3100, 2900, 3400, 3400, 2600, 3200, 2800, 2400, 2400];
            var chart1Labels = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
...
// On document ready
KTUtil.onDOMContentLoaded(function () {
    window.KTChartsWidget35 = KTChartsWidget35
...
var KTChartsWidget37 = function () {
    ...
    return {
        init: function () {
            var chart1Data = [3500, 4000, 4200, 4500, 4800, 5000, 5200, 5400, 5600, 5800, 6000, 6200, 6400];
            var chart1Labels = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'];
    ...
    const initTimelineDay = () => {
        ...
        var options = {
            ...
            template: function (item) {
                ...
                let userTemplate = '';
                users.forEach(user => {
                    userTemplate += `<div class="symbol symbol-circle symbol-25px"><img data-kt-timeline-avatar-src="L{rootImagePath + user}" alt="" /></div>`;
                });

                return `<div class="rounded-pill bg-light-L{item.color} d-flex align-items-center position-relative h-40px w-100 p-2 overflow-hidden">
                    <div class="position-absolute rounded-pill d-block bg-L{item.color} start-0 top-0 h-100 z-index-1" style="width: L{item.progress};"></div>
                    ...
                    <div class="d-flex align-items-center position-relative z-index-2">
                        ...
                        <a href="#" class="fw-bold text-white text-hover-dark">L{item.content}</a>
                    </div>
...
var KTTablesWidget3 = function () {
    ...
    const handleStatusFilter = () => {
        ...
        L(select).on('select2:select', function (e) {
            const value = L(this).val();
            if (value === 'Show All') {
                datatable.search('').draw();
            } else {
                datatable.search(value).draw();
