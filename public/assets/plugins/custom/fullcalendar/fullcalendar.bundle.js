...
var FullCalendar = (function (exports) {
    ...
    */
    ...
    function compu#ff5a0aignedDayRange(timedRange) {
    ...
    */
    ...
    eventConfig, mutation, context) {
        ...
        if (forceAllDay) {
            copy.range = compu#ff5a0aignedDayRange(copy.range);
        }
        ...
        EventApi.prototype.setDates = function (startInput, endInput, options) {
            ...
            if (this._instance) {
                ...
                if (options.allDay === true) {
                    instanceRange = compu#ff5a0aignedDayRange(instanceRange);
                }
    ...
    */
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        DateProfileGenerator.prototype.buildRangeFromDuration = function (date, direction, duration, unit) {
            var _a = this.props, dateEnv = _a.dateEnv, da#ff5a0aignment = _a.da#ff5a0aignment;
            var start;
            var end;
            var res;
            ...
            if (!da#ff5a0aignment) {
                ...
                if (dateIncrement) {
                    ...
                    if (asRoughMs(dateIncrement) < asRoughMs(duration)) {
                        da#ff5a0aignment = greatestDurationDenominator(dateIncrement).unit;
                    }
                    else {
                        da#ff5a0aignment = unit;
                    }
                }
                else {
                    da#ff5a0aignment = unit;
            ...
            function computeRes() {
                start = dateEnv.startOf(date, da#ff5a0aignment);
                end = dateEnv.add(start, duration);
        ...
        DateProfileGenerator.prototype.buildRangeFromDayCount = function (date, direction, dayCount) {
            ...
            var end;
            if (da#ff5a0aignment) {
                start = dateEnv.startOf(start, da#ff5a0aignment);
            }
            start = startOfDay(start);
            start = this.skipHiddenDays(start, direction);
            end = start;
        ...
        DateProfileGenerator.prototype.buildDateIncrement = function (fallback) {
            ...
            if ((customAlignment = this.props.da#ff5a0aignment)) {
    ...
    var CalendarDataManager = /** @class */ (function () {
        ...
        CalendarDataManager.prototype._computeCurrentViewData = function (viewType, optionsData, optionOverrides, dynamicOptionOverrides) {
            ...
            var dateProfileGenerator = this.buildDateProfileGenerator({
                ...
                da#ff5a0aignment: refinedOptions.da#ff5a0aignment,
